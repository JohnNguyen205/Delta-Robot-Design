...
> (`KinematicsSimulation/`, `ForceAnalysis/`).
...
![Hình 7. Độ lớn lực đầu công tác theo thời gian](../ForceAnalysis/figs/force_ee.png)

![Hình 8. Lực dọc 3 cặp cẳng tay theo thời gian](../ForceAnalysis/figs/forearm_forces.png)

![Hình 9. Momen khớp nặng nhất theo thời gian, tách thành phần tĩnh/động/tổng; đường ngang là ngưỡng T2B = 230 N·m và momen liên tục 110 N·m của hộp số đã chọn TPMA010S-055T](../ForceAnalysis/figs/joint_torques.png)
...
minh chọn động cơ `ForceAnalysis/ThuyetMinh_ChonDongCo.md`). Kết quả: $M_{yc}=k_s(M_{tĩnh}+M_{động})
...
hình trong `KinematicsSimulation/figs/` và `ForceAnalysis/figs/`.
