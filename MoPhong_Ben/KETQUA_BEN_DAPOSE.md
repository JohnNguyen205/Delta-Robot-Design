...
## 2. Phân tích tải theo tư thế (MATLAB `MoPhong_Luc/force_poses.m`)
...
- Tải theo tư thế (MATLAB): `MoPhong_Luc/force_poses.m`, `out/pose_log.txt`, `out/pose_results.mat`,
  `figs/pose_fmax_workspace.png` (bản đồ lực cặp thanh truyền trên vùng làm việc).
- FEA worst-pose (SolidWorks): `MoPhong_Ben/run_parts_pose.ps1`, `out/conv_{dr006,dr005b,dr001_1}_pose.csv`,
