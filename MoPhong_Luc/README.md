...
## Cách chạy
```
E:\Mathlab\bin\matlab.exe -batch "cd('F:/DeltaRobot/MoPhong_Luc'); force_analysis"
E:\Mathlab\bin\matlab.exe -batch "cd('F:/DeltaRobot/MoPhong_Luc'); moment_angle_sweep"
E:\Mathlab\bin\matlab.exe -batch "cd('F:/DeltaRobot/MoPhong_Luc'); force_diagrams"
```
