...
%        FEA_Simulation/run_parts.ps1 va run_parts_pose.ps1.
...
%                  ForceAnalysis/force_poses.m va FEA_Simulation/run_parts_pose.ps1)
...
%  (a) FEA_Simulation/run_parts.ps1 dong 7: "Fix F3 R22.5 bore y=+135 ...
%      Load F9 R22.5 bore y=-135" -> khoang cach = 135-(-135) = 270 mm.
%  (b) FEA_Simulation/THUYETMINH_MOPHONG_BEN_CHITIET.md muc 8 (dong ~271):
...
% Nguon: FEA_Simulation/KETQUA_BEN.md muc 8.2 (dong ~191-201) -- CHEP LAI,
...
%  FEA_Simulation/run_parts.ps1       dong 17-21 (Comp=@(...))
%  FEA_Simulation/run_parts_pose.ps1  dong 10-14 (Comp=@(...))
